...
<div id="page_content_left">
    ...
    <div class="content_text">
        ...
        of manly muscles. So I keep them lean, with
        out any big biceps or thighs.
    </div>
    <div class="content_text">
        <img src="/images/MUSTANG-4--300x213.gif" width="150" height="106" alt="pic" title="pic" class="pic"/>
        As for the cars, because cars are such complex machines, I like to use reference material, especially if the car
        is featured fairly prominently. Most
        of the time, the angle of the car I'm drawing won't match the shot of the car in the photo, so I have to
        improvise. A very useful skill to develop is the ability
        to rotate the car maintains the same proportions and doesn't become too long or too compact as the viewing angle
        changes.
    </div>
    <%--
        <div class="title">
...
<div id="page_content_right">
    ...
    <div class="content_text">
        ...
        %>
        --No recent pictures added. Please visit Gallery to view existing pictures--
        <%
            }
        %>
    </div>
